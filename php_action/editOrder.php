...
if($_POST) {
  ...
  $cgst 						= $_POST['cgst'];
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', client_name = '$clientName', client_contact = '$clientContact', sub_total = '$subTotalValue', vat = '$vatValue', vat1 = '$vatValue1', total_amount = '$totalAmountValue', discount = '$discount', grand_total = '$grandTotalValue', paid = '$paid', due = '$dueValue', payment_type = '$paymentType', payment_status = '$paymentStatus', order_status = 1, client_add = '$clientaddress', client_Gst = '$clientgst_no', sgst='$sgst', cgst='$cgst' WHERE order_id = {$orderId}";	
	$connect->query($sql);
