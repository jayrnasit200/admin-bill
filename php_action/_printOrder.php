    ...
    <div class="row" style="padding: 0px 15px 0 14px;">
        <div class="col-xs-12" style="border: 1px solid;">
            ...
            <div class="invoice-title">
                <h2 style="margin: 5px 34px;"><?php echo $result['username']; ?></h2>
            </div>
            </center>
            <div class="row" style="border-top: 1px solid;">
                ...
                <div class="col-xs-4"style="border-right: 1px solid;height: 70px;">
                    <address>
                        ...
                        <strong>Mobile No :-</strong><?php echo $orderData['client_contact'];?><br>
                        <strong>GST :- </strong><?php echo $orderData['client_Gst'];?><br>
                    </address>
                </div>
...
<script type="text/javascript">
    ...
    window.location.href = 'http://localhost/admin/orders.php?o=manord';
}, 1000);
</script>