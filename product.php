    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">MRP: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="pro_mrp" placeholder="MRP" name="pro_mrp" autocomplete="off">
				    </div>
	        </div>
	        ...
	        <div class="form-group">
	         ...
	         <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">HSN: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	         ...
	         <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">GST(Text): </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="gst_rate"  name="gst_rate">
				      	<option>Selects Gst</option>
	        ...
	        <div class="form-group" style="display: none;">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select type="text" class="form-control" id="categoryName" placeholder="Product Name" name="categoryName" style="display: none;">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">MRP: </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editmrp" placeholder="Rate" name="editmrp" autocomplete="off">
						    </div>
			        </div>
			        <div class="form-group">
	         ...
	         <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="editgst_rate"  name="editgst_rate">
				      	<option>Selects Gst</option>
				      	<option value="0">0%</option>
				      	<option value="18%">18%</option>
				      	<option value="12%">12%</option>
