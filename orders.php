	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientaddress" name="clientaddress" placeholder="Client Address" autocomplete="off" />
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client GST-NO</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientgst_no" name="clientgst_no" placeholder="Client GST-NO" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" style="display: none;">
				    <label for="vat" c18lass="col-sm-3 control-label">SGST<select id="sgst" name="sgst" onchange="subAmount()">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat" name="vat1" disabled="true" />
				      <input type="hidden" class="form-control" id="vatValue" name="vatValue1" />
				    </div>
				  </div>
				  <div class="form-group" style="display: none;">
				    <label for="vat" class="col-sm-3 control-label">CGST<select id="cgst" name="cgst" onchange="subAmount()">
				  ...
				  <div class="form-group" style="display: none;">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" value="0" name="discount" onkeyup="discountFunc()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
  			...
  			$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.vat1, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status , orders.client_add, orders.client_Gst, orders.sgst, orders.cgst FROM orders 	
			  ...
			  <div class="form-group">
			   ...
			   <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client Address</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientaddress" value="<?php echo $data[14] ?>" name="clientaddress" placeholder="Client Address" autocomplete="off" />
			    </div>
			  </div>
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Client GST-NO</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="clientgst_no" value="<?php echo $data[15] ?>" name="clientgst_no" placeholder="Client GST-NO" autocomplete="off" />
			    </div>
			  </div> <!--/form-group-->			  
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group" style="display: none;">
				    <label for="vat" class="col-sm-3 control-label">SGST<select id="sgst" name="sgst" onchange="subAmount()">
				    	
				    	<option value="0" <?php if ($data[16] == '0') { echo "selected";}?>>0%</option>
				    	<option value="14"<?php if ($data[16] == '14') { echo "selected";}?>>14%</option>
				    	<option value="9" <?php if ($data[16] == '9') { echo "selected";}?>>9%</option>
				    	<option value="8" <?php if ($data[16] == '8') { echo "selected";}?>>8%</option>
				    </select></label>
				  ...
				  <div class="form-group" style="display: none;">
				    <label for="vat" class="col-sm-3 control-label">CGST<select id="cgst" name="cgst" onchange="subAmount()">
				    	<option value="0" <?php if ($data[17] == '0') { echo "selected";}?>>0%</option>
				    	<option value="14"<?php if ($data[17] == '14') { echo "selected";}?>>14%</option>
				    	<option value="9" <?php if ($data[17] == '9') { echo "selected";}?>>9%</option>
				    	<option value="8" <?php if ($data[17] == '8') { echo "selected";}?>>8%</option>
				    </select></label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="vat1" name="vat1" disabled="true" value="<?php echo $data[6] ?>"  />
				      <input type="hidden" class="form-control" id="vatValue1" name="vatValue1" value="<?php echo $data[6] ?>"  />
				    </div>
				  </div>
				   <!--/form-group-->			  
				  <div class="form-group">
				  ...
				  <div class="form-group" style="display: none;">
				    <label for="discount" class="col-sm-3 control-label">Discount</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" value="0" name="discount" onkeyup="discountFunc()" autocomplete="off" value="<?php echo $data[8] ?>" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Grand Total</label>
