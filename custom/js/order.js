...
function subAmount() {
	...
	// vat
	var vat = (Number($("#subTotal").val())/100) * sgst;
	var vat1 = (Number($("#subTotal").val())/100) * cgst;
	...
	// total amount
	var totalAmount08 = (Number($("#subTotal").val()) + Number($("#vat").val()));
	var totalAmount = (Number(totalAmount08) + Number($("#vat1").val()));
